...
import XPSEpoxyFloorPlanner from '@/pages/XPSEpoxyFloorPlanner';
    ...
    <AnimatePresence mode="wait">
      <Routes>
        <Route element={<SiteLayout />}>
          ...
          <Route path="/xps-epoxy-floor-planner" element={<PageTransition><XPSEpoxyFloorPlanner /></PageTransition>} />
        </Route>
