                ...
                <div className="text-center space-y-6">
                            ...
                            <div className="flex items-start space-x-3">
                                ...
                                <div className="text-left space-y-1">
                                    ...
                                    <p className="text-sm text-muted-foreground leading-relaxed">
                                        This route has not been implemented in the Strategic Minds native app yet.
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="pt-6">
                        <button 
                            ...
                            className="inline-flex items-center px-4 py-2 text-sm font-medium text-foreground bg-card border border-border rounded-lg hover:bg-secondary transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-ring"
                        >
