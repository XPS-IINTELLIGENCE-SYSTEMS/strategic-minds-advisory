    ...
    <AnimatePresence>
      {transcript || isListening ? (
        <motion.div
          ...
          exit={{ opacity: 0, y: 20 }}
          className="md:hidden fixed bottom-24 left-4 right-4 z-40 bg-card/95 backdrop-blur-md border border-border rounded-2xl p-4 shadow-xl"
        >
        ...
        <motion.button
          ...
          className="md:hidden fixed bottom-20 right-4 z-40 w-14 h-14 rounded-full bg-accent hover:bg-accent/90 text-primary-foreground shadow-lg flex items-center justify-center transition active:scale-95"
          title="Voice input"
        >
