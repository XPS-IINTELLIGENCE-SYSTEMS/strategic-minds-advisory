...
insert into ai_invention_requests (
  ...
  '["/api/sandbox/generated?slug=ai-habit-drill-coach"]'::jsonb,
  '["ai_invention_requests","ai_invention_runs","ai_invention_proofs"]'::jsonb,
  'Prove the AI Invention Factory Generator can create a second sandbox invention package, deploy it, and validate the generated API route after direct deploy dispatch hardening.',
